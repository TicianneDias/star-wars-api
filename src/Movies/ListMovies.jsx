    ...
    <>
      <Container>
        <List>
                ...
                <Movie key={movie.episode_id}>
                  <IMG
                    src={
                      movie.episode_id === 1
                        ? IMG1
                        : false || movie.episode_id === 2
                        ? IMG2
                        : false || movie.episode_id === 3
                        ? IMG3
                        : false || movie.episode_id === 4
                        ? IMG4
                        : false || movie.episode_id === 5
                        ? IMG5
                        : false || movie.episode_id === 6
                        ? IMG6
                        : false
                    }
                    alt={`Poster Movie of ${movie.title}`}
                  />
                  <h1>{movie.title}</h1>
          ...
          {otherMovies.map(
            ({ id, title, image, sinopse, director, dateMovie, episode }) => {
              return (
                <>
                  <Movie key={id}>
